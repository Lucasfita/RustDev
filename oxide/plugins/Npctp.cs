...
{
    [Info("Npctp", "Ts3hosting", "2.4.4", ResourceId = 2229)]
    ...
    class Npctp : RustPlugin
    {
        ...
        void OnEnterNPC(BasePlayer npc, BasePlayer player)
        {
            ...
            if (NoPermDie == false || permission.UserHasPermission(player.userID.ToString(), Perms) || KillSleepA == true || player.userID < 76560000000000000L) return;
            if (UseGunToKill)
